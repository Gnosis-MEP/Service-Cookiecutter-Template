...
class Test{{ cookiecutter.service_class_name }}(MockedEventDrivenServiceStreamTestCase):
    ...
    SERVICE_CLS = {{ cookiecutter.service_class_name }}
    ...
    MOCKED_STREAMS_DICT = {
        SERVICE_STREAM_KEY: [],
        'cg-{{ cookiecutter.service_class_name }}': MOCKED_CG_STREAM_DICT,
    }

    @patch('{{ cookiecutter.package_name }}.service.{{ cookiecutter.service_class_name }}.process_event_type')
