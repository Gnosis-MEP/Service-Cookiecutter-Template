...
class Test{{ cookiecutter.service_class_name }}(MockedServiceStreamTestCase):
    ...
    @patch('{{ cookiecutter.package_name }}.service.{{ cookiecutter.service_class_name }}.process_action')
